      ...
      footer={
        <>
          ...
          <button
            ...
            disabled={!folderId || !selectedFile}
    ...
    >
      <div className="space-y-6">
        ...
        <div className="space-y-2">
          ...
          {!selectedFile ? (
            <div
              ...
              className="border-2 border-dashed border-slate-200 rounded-2xl p-8 flex flex-col items-center justify-center gap-3 hover:border-blue-400 hover:bg-blue-50 transition-all cursor-pointer group"
            >
            ...
            <div className="flex items-center justify-between p-4 bg-blue-50 border border-blue-100 rounded-2xl">
              ...
              <button
                ...
                className="p-1 hover:bg-blue-100 rounded-full text-slate-400 hover:text-red-500 transition-colors"
              >
                <X size={18} />
              </button>
            </div>
        ...
        <div className="space-y-2">
          ...
          <div className="p-1 bg-slate-50 border border-slate-200 rounded-xl max-h-40 overflow-y-auto">
            {folders
              .filter((f) => !f.parentId)
              .map((folder) => (
                <TreeSelectNode
